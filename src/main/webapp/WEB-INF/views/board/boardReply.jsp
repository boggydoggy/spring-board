    ...
    <div id="container">
      <div class="inner">
        ...
        <form id="boardForm" name="boardForm">
          <input type="hidden" id="board_parent_seq"
            name="board_parent_seq" value="${boardSeq}" />
          <!-- 부모 게시글 번호 -->
          <table width="100%" class="table02">
            ...
            <tbody id="tbody">
              <tr>
                ...
                <td><input id="board_subject" name="board_subject"
                  value="" class="tbox01" /></td>
              </tr>
              <tr>
                <th>작성자<span class="t_red">*</span></th>
                <td><input id="board_writer" name="board_writer"
                  value="" class="tbox01" /></td>
              </tr>
              <tr>
                <th>내용<span class="t_red">*</span></th>
                <td><textarea id="board_content"
                  name="board_content" cols="10" rows="5"
        ...
        <div class="btn_right mt15">
          ...
          <button type="button" class="btn black"
            onclick="javascript:insertBoardReply();">등록하기</button>
        </div>
      </div>
    </div>
  </div>
