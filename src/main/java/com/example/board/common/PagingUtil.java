...
public class PagingUtil {
    ...
    public static CommonDto setPageUtil(CommonForm commonForm) {
        ...
        String functionName = commonForm.getFunction_name(); // 페이징 목룍을 요청하는 자바 스크립트 함수명
        ...
        if (totalListCount % countPerList > 0) { // 총 페이지 수를 구할 때 int형으로 계산하면 나머지가 있는 경우 게시물이 존재하기 때문에 총 페이지 수 수정
